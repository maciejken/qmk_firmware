...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_82(
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  KC_COPY,  KC_PASTE, KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_DEL, KC_SLEP,
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_1,     KC_2,     PL_SACU,  KC_F,     PL_ZACU,  KC_6,     KC_7,     PL_CACU,  PL_NACU,  KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
    ...
    [WIN_FN] = LAYOUT_ansi_82(
        QK_BOOT,            KC_BRID,  KC_BRIU,  _______,  _______,  KC_COPY,  KC_PASTE,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  _______,
        _______,  _______,  KC_P7,    KC_P8,    KC_P9,    KC_PSLS,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        KC_NUM,   RM_NEXT,  KC_P4,    KC_5,     KC_P6,    KC_PAST,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  RM_PREV,  KC_P1,    KC_P2,    KC_P3,    KC_PMNS,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,
        _______,            _______,  KC_PEQL,  KC_PDOT,  KC_P0,    KC_PPLS,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______)
};
