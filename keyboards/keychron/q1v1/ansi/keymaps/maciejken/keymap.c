...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD,                                KC_SPC,                                 MO(1),    KC_RCMD, KC_RCTL,   KC_LEFT,  KC_DOWN, KC_RGHT),
    ...
    [2] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LWIN,  KC_LCMD,                                KC_SPC,                                 MO(3),    KC_RCMD,  KC_RCTL,  KC_LEFT,  KC_DOWN, KC_RGHT),
    ...
    [3] = LAYOUT_ansi_82(
        ...
        _______,            KC_LPRN,  KC_RPRN,  KC_EQL ,  KC_0,     KC_PLUS,  _______,  _______,  _______,  _______,  _______,            TG(4),    _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______, _______),
    ...
    [4] = LAYOUT_ansi_82(
        ...
        KC_CAPS,  KC_A,     KC_O,     KC_E,     KC_U,     KC_I,     KC_D,     KC_H,     KC_T,     KC_N,     KC_S,     KC_MINS,            KC_ENT,            KC_HOME,
        KC_LSFT,            KC_SCLN,  KC_Q,     KC_J,     KC_K,     KC_X,     KC_B,     KC_M,     KC_W,     KC_V,     KC_Z,               KC_RSFT,  KC_UP,
        KC_LCTL,  KC_LOPT,  KC_LCMD,                                KC_SPC,                                 TG(4),    KC_RCMD, KC_RCTL,   KC_LEFT,  KC_DOWN, KC_RGHT)
};
