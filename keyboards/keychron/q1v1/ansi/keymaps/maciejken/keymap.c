...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_LPRN,  KC_X,     PL_SACU,  KC_F,     PL_ZACU,  KC_Q,     PL_ZDOT,  PL_CACU,  PL_NACU,  KC_V,     KC_LBRC,  KC_RBRC,  KC_BSPC,           KC_PGUP,
    ...
    [1] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_RPRN,  _______,  _______,  _______,           RM_HUEU,
        RM_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  KC_6,     KC_7,     KC_8,     KC_9,     KC_PERC,  _______,  _______,           RM_HUED,
        _______,  _______,  _______,  _______,  _______,  _______,  KC_0,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,               _______,           RM_SATD,
        _______,            _______,  _______,  _______,  _______,  _______,  KC_EXLM,  KC_DOT,   KC_AT,    KC_HASH,  KC_DLR,             _______,  RM_SPDU,
