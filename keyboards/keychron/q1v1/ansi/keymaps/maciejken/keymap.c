...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LCMD,  KC_LOPT,                                KC_SPC,                                 MO(1),    KC_ROPT,  KC_RCTL,  KC_LEFT,  KC_DOWN, KC_RGHT),
    ...
    [2] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_EXLM,  KC_X,     PL_SACU,  KC_F,     PL_ZACU,  KC_Q,     PL_ZDOT,  PL_CACU,  PL_NACU,  KC_V,     KC_LBRC,  KC_RBRC,  KC_BSPC,           KC_PGUP,
        KC_TAB,   KC_P,     KC_COMM,  KC_DOT,   KC_U,     KC_B,     KC_J,     KC_T,     KC_C,     KC_K,     KC_D,     KC_QUES,  KC_EQL,   KC_BSLS,           KC_PGDN,
    ...
    [3] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_7,     KC_8,     KC_9,     KC_0,     _______,  _______,  _______,           RM_HUEU,
        RM_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  KC_4,     KC_5,     KC_6,     KC_ASTR,  KC_SLSH,  _______,  _______,           RM_HUED,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_1,     KC_2,     KC_3,     KC_PLUS,  _______,            _______,           RM_SATD,
        _______,            _______,  _______,  _______,  _______,  _______,  KC_LPRN,  KC_RPRN,  _______,  _______,  _______,            _______,  RM_SPDU,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  RM_PREV,  RM_SPDD, RM_NEXT),
